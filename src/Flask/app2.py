...
@app.route("/weather_by_city", methods=["GET"])
def get_weather_by_city():
    """Endpoint to fetch current weather data using city name."""
    ...
    if weather_data:
        ...
        return jsonify({"error": "Failed to fetch weather data for the city"}), 500
